...
API
1. java.util.Date---a class , that  represents system date n time , till the msec precision
Constructor
...
Methods --public String toString() : overriding form : rets date n time
...
eg : d1.compareTo(d2)
Rets < 0 , if d1 is before d2
= 0 , if d1.equals(d2) : true
> 0 , if d1 is after d2

Date class implements : java.lang.Comparable<Date>
String , all wrapper classes also implement it.

java.lang.Comparable<T>  : i/f , used in natural ordering in Java
T : type of the object to compare.
Method : public int compareTo (T o)
Rets : < 0 , if this < o (as per the contents)
=0 , if this=o (as per the contents)
> 0 if this > o (as per the contents)
---------------------
